  ...
  async createQuestion(data = {}) {
    ...
    const result = await pool.query(`
      INSERT INTO PlacementTestQuestions
        (TestId, QuestionType, Skill, Prompt, OptionA, OptionB, OptionC, OptionD, CorrectAnswer, AcceptedAnswers, Explanation, SourceSkill, SourceQuestionId, OrderIndex, UpdatedAt)
